    ...
    products.forEach(product => {
      ...
      productCard.innerHTML = `
        ...
        <div class="p-6">
          ...
          <p class="text-cream-700 mb-4 text-justify">${product.description}</p>
          <div class="flex items-center justify-between ">
            <span class="text-l font-semibold text-cream-800">${product.price}</span>
            <a href="${whatsappUrl}" target="_blank"rel="noopener noreferrer"class="px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-full text-sm font-semibold transition-colors">
              Order Now
            </a>
          </div>
        </div>
